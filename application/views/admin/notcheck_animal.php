...
<div id="tab2">
				<div class="panelBar">
		<ul class="toolBar">
			<li><a class="delete" href="index.php/api/del_animal/{animalid}/notcheck_animal" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
...
?>
			<tr target="animalid" rel="<?php echo $animal['id'];?>">
				...
				<td><a  href="<?php echo base_url('index.php/admin/checking/animal/'.$animal['id']);?>" target="navTab" rel="dlg_page12"><span>查看详情</span></a></td>
			</tr>
<?php 
}
?>
